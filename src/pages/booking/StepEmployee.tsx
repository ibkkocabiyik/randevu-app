    ...
    <div className="space-y-5 pb-4">
      ...
      <div>
        ...
        <div className="flex items-center gap-1.5 mt-1.5">
          <span className="inline-flex items-center gap-1 text-xs font-medium text-[#6366F1] bg-indigo-50 dark:bg-indigo-900/30 px-2 py-0.5 rounded-full">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center flex-wrap gap-x-3 gap-y-0.5 mt-1">
                  <span className="flex items-center gap-1 text-xs text-gray-400">
                    <Clock size={11} />
                    {e.workingHours.start} – {e.workingHours.end}
                  </span>
                  {done > 0 && (
                    <span className="flex items-center gap-1 text-xs text-gray-400">
                  ...
                  {avg !== null && (
                    <span className="flex items-center gap-0.5 text-xs text-amber-500 font-medium">
                      ...
                      {avg.toFixed(1)}
                      <span className="text-gray-400 font-normal ml-0.5">({reviewCount})</span>
                    </span>
                  )}
                </div>
              </div>
